import { View, SafeAreaView, StyleSheet, Text, TouchableOpacity, Animated, Easing } from 'react-native'
...
const Details = ({}) => {
      ...
      <View style={{ padding:5,flex: 1 }}>
        <View style={{ width: '100%', height: 80, flexDirection: 'row', }}>
          ...
          <View style={{ width: '35%', height: '100%', alignItems: 'center' }}>
            <Text style={{ alignSelf: 'center', fontSize: 20, fontWeight: 'bold', color: colors.white }}>{detailsData.station}</Text>
          </View>
  ...
  const ModalpopupData = ({ navigation, navigate, props }) => {
    return (
      <View style={{ backgroundColor: colors.black, width: '100%', height: 80, top: 100 }}>
        <Text>2</Text>
      </View>
    );
  }
      ...
      <View style={{
        ...
        {isFilterVisible && (
          <Animated.View style={{
            ...
            <View style={{ padding: 10, width: '100%', flexDirection: 'column' }}>
              <Modalpopup />
              <ModalpopupData />
            </View>
